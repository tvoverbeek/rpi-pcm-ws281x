...
class Adafruit_NeoPixel(object):
	def __init__(self, num, pin, freq_hz=800000, dma=5, invert=False, brightness=128):
		"""Class to represent a NeoPixel/WS281x LED display.  Num should be the
		number of pixels in the display, and pin should be the GPIO pin connected
		to the display signal line (must be a PCM pin like 21!).  Optional
		...
		"""
                ...
                # Create ws2811_channel_t structure and fill in parameters
		self._channel = ws.new_ws2811_channel_t()
		...
		ws.ws2811_t_dmanum_set(self._leds, dma)
                ws.ws2811_t_channel_set(self._leds, self._channel)
