...
/*-----------------------------------------------
              @(target):= _rpi_pcm_ws281x.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__rpi_pcm_ws281x

#else
#  define SWIG_init    init_rpi_pcm_ws281x

#endif
#define SWIG_name    "_rpi_pcm_ws281x"
...
SWIGINTERN PyObject *_wrap_ws2811_t_channel_set(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  arg1 = (ws2811_t *)(argp1);
  res2 = SWIG_ConvertPtr(obj1, &argp2,SWIGTYPE_p_ws2811_channel_t, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "ws2811_t_channel_set" "', argument " "2"" of type '" "ws2811_channel_t *""'"); 
  }
...
SWIGINTERN PyObject *_wrap_ws2811_t_channel_get(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  arg1 = (ws2811_t *)(argp1);
  result = (ws2811_channel_t *) ((arg1)->channel);
